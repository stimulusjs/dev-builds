...
(function(global, factory) {
  ...
  var ValueObserver = function() {
    ...
    ValueObserver.prototype.getKeysByAttributeName = function() {
      ...
      return Object.keys(this.valueAttributeMap).reduce(function(keys, attributeName) {
        var _a;
        return __assign({}, keys, (_a = {}, _a[_this.valueAttributeMap[attributeName]] = attributeName, 
        _a));
      }, {});
    };
      ...
      valueAttributeMap: {
        get: function() {
          ...
          return valueDefinitions.reduce(function(result, valueDefinition) {
            ...
            return __assign$1({}, result, (_a = {}, _a[name] = _this.data.getAttributeNameForKey(key), 
            _a));
          }, {});
        }
      }
  ...
  function propertiesForValueDefinition(valueDefinition) {
    ...
    var getDefaultValue = defaultValue instanceof Function ? defaultValue : function() {
      return defaultValue;
    };
    var read = readers[type];
    return _a = {}, _a[name] = {
      get: defaultValue == undefined ? getOrThrow(key, read) : getWithDefault(key, read, getDefaultValue),
      set: function(value) {
        if (value == undefined) {
