...
(function(global, factory) {
  ...
  function readInheritableStaticArray(constructor, propertyName) {
  ...
  var descriptorPattern$1 = /([^.=]+)\.([^=]+)=(.+)/;
  function parseDescriptorString$1(descriptorString) {
    var source = descriptorString.trim();
    var matches = source.match(descriptorPattern$1);
    if (matches) {
    ...
    Object.defineProperty(ClassMap.prototype, "values", {
      get: function() {
        ...
        return this.descriptorStrings.reduce(function(values, descriptorString) {
          var descriptor = parseDescriptorString$1(descriptorString);
  ...
  function propertiesForValueDefinition(valueDefinition) {
    ...
    return _a = {}, _a[name] = {
      get: defaultValue == undefined ? getOrThrow(key, read) : getWithDefault(key, read, defaultValue),
      set: function(value) {
        if (value == undefined) {
