...
var DOMTestCase = /** @class */ (function (_super) {
    ...
    DOMTestCase.prototype.triggerEvent = function (selectorOrTarget, type, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, bubbles, setDefaultPrevented, eventTarget, event;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = __assign(__assign({}, defaultTriggerEventOptions), options), bubbles = _a.bubbles, setDefaultPrevented = _a.setDefaultPrevented;
